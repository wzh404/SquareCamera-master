...
//            Log.d(TAG, "viewWidth: " + viewWidth);
        ...
        if (null == paint) {
            paint = new Paint();
            paint.setColor(Color.parseColor("#89d4ef"));//"#83cde6"));
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                canvas.drawLine(viewWidth * 1 / 6, itemHeight + itemHeight/2 - dip2px(25f), viewWidth * 5 / 6, itemHeight + itemHeight/2 - dip2px(25f), paint);
                canvas.drawLine(viewWidth * 1 / 6, itemHeight + itemHeight/2 + dip2px(25f), viewWidth * 5 / 6, itemHeight + itemHeight/2 + dip2px(25f), paint);
            }
